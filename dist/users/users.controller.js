...
let UsersController = class UsersController {
    ...
    async updateShippingAddress(req, updateShippingAddressDto) {
        return this.usersService.updateShippingAddress(req.user.id, updateShippingAddressDto.address);
    }
    async updatePhoneNumber(updatePhoneNumberDto, req) {
        return this.usersService.updatePhoneNumber(req.user.id, updatePhoneNumberDto.phoneNumber);
    }
    ...
    async updatePassword(req, updatePasswordDto) {
        return this.usersService.updatePassword(req.user.id, updatePasswordDto.password);
    }
};
...
__decorate([
    ...
    (0, common_1.Patch)('/shipping-address'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, update_user_dto_1.UpdateShippingAddressDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "updateShippingAddress", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, common_1.Patch)('/phone-number'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_user_dto_1.UpdatePhoneNumberDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, update_name_dto_1.UpdateNameDto]),
    __metadata("design:returntype", Promise)
